...
type ComplexityRoot struct {
	...
	Film struct {
		Id         func(childComplexity int) int
		BomId      func(childComplexity int) int
		Title      func(childComplexity int) int
		GrossDaily func(childComplexity int, from *time.Time, to *time.Time) int
	}

	Query struct {
		GetFilm func(childComplexity int, id string) int
	}
}
...
func field_Film_grossDaily_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
...
func field_Query_getFilm_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 string
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "DailyGross.id":
		if e.complexity.DailyGross.Id == nil {
			break
		}
	...
	case "DailyGross.gross":
		...
		return e.complexity.DailyGross.Gross(childComplexity), true
	...
	case "Film.bomID":
		if e.complexity.Film.BomId == nil {
			break
		}

		return e.complexity.Film.BomId(childComplexity), true
	...
	case "Film.grossDaily":
		if e.complexity.Film.GrossDaily == nil {
			break
		}

		args, err := field_Film_grossDaily_args(rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Film.GrossDaily(childComplexity, args["from"].(*time.Time), args["to"].(*time.Time)), true

	case "Query.getFilm":
		if e.complexity.Query.GetFilm == nil {
			break
		}

		args, err := field_Query_getFilm_args(rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.GetFilm(childComplexity, args["id"].(string)), true
...
var dailyGrossImplementors = []string{"DailyGross"}

// nolint: gocyclo, errcheck, gas, goconst
func (ec *executionContext) _DailyGross(ctx context.Context, sel ast.SelectionSet, obj *model.DailyGross) graphql.Marshaler {
	fields := graphql.CollectFields(ctx, sel, dailyGrossImplementors)
	...
	for i, field := range fields {
		...
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("DailyGross")
		case "id":
			out.Values[i] = ec._DailyGross_id(ctx, field, obj)
...
// nolint: vetshadow
func (ec *executionContext) _DailyGross_id(ctx context.Context, field graphql.CollectedField, obj *model.DailyGross) graphql.Marshaler {
...
func (ec *executionContext) _Film(ctx context.Context, sel ast.SelectionSet, obj *model.Film) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "bomID":
			out.Values[i] = ec._Film_bomID(ctx, field, obj)
		case "title":
...
// nolint: vetshadow
func (ec *executionContext) _Film_bomID(ctx context.Context, field graphql.CollectedField, obj *model.Film) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Film",
		Args:   nil,
		Field:  field,
...
// nolint: vetshadow
func (ec *executionContext) _Film_grossDaily(ctx context.Context, field graphql.CollectedField, obj *model.Film) graphql.Marshaler {
	...
	for idx1 := range res {
		...
		f := func(idx1 int) {
			...
			arr1[idx1] = func() graphql.Marshaler {
				...
				return ec._DailyGross(ctx, field.Selections, &res[idx1])
			}()
		}
		if isLen1 {
			f(idx1)
...
func (ec *executionContext) _Query(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "getFilm":
			wg.Add(1)
			go func(i int, field graphql.CollectedField) {
				out.Values[i] = ec._Query_getFilm(ctx, field)
				wg.Done()
			}(i, field)
		case "__type":
...
// nolint: vetshadow
func (ec *executionContext) _Query_getFilm(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := field_Query_getFilm_args(rawArgs)
	if err != nil {
		ec.Error(ctx, err)
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Query().GetFilm(ctx, args["id"].(string))
	})
	if resTmp == nil {
		return graphql.Null
	}
